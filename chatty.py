...
def main():
    ...
    # Input fields
    data_description = st.write_area("Enter Data Description", "Data includes various facts about Health, Mental health challenges, and Health centers in St.Kitts.")
